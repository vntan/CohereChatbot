  ...
  return (
    ...
    >
      ...
      <div className={`${styles["mainContent"]} bg-white row`}>
        ...
        <div
          className={`${styles["mainContent-loginForm"]} col-sm-8 d-sm-flex flex-column justify-content-center align-items-center`}
        >
          <div
          ...
          >
            ...
            {error.length !== 0 && (
              <div
                className={`${styles["wrapperForm-alert"]} alert alert-danger`}
                role="alert"
              >
                {error}
              </div>
          ...
          <div>
            <form className={`${styles["wrapperForm-form"]} alert-danger`}>
              ...
              <label>Password</label>
                ...
                />
                <div className={`forget_password ${styles["forget_password"]}`}>
            ...
            <div className={`${styles["signup"]}`}>
              You don't have an account? <Link to="/register">Join Now</Link>{" "}
            </div>
          </div>
        </div>
      </div>
